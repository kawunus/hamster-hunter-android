...
sealed class VacancyDetailsState {
    ...
    data class VacancyLiked(val details: VacancyDetails, val isLiked: Boolean) : VacancyDetailsState()
    //data class VacancyNotLiked(val details:VacancyDetails):VacancyDetailsState()
}
