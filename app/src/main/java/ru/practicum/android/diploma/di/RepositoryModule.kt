...
import ru.practicum.android.diploma.filter.data.impl.IndustriesRepositoryImpl
import ru.practicum.android.diploma.filter.data.impl.RegionsRepositoryImpl
...
val repositoryModule = module {
    ...
    singleOf(::IndustriesRepositoryImpl) { bind<IndustriesRepository>() }
